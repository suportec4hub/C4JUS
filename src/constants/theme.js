export const L = {
  ...
  copperA:"var(--c-copperA)",

  // Status
  green:"var(--c-green)", greenBg:"var(--c-greenBg)",
  greenA:"var(--c-greenA)", greenA2:"var(--c-greenA2)",
  red:"var(--c-red)", redBg:"var(--c-redBg)",
  redA:"var(--c-redA)", redA2:"var(--c-redA2)", redA3:"var(--c-redA3)",
  yellow:"var(--c-yellow)", yellowBg:"var(--c-yellowBg)",
  yellowA:"var(--c-yellowA)", yellowA2:"var(--c-yellowA2)",
...
export const globalCSS = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  :root {
    ...
    --c-accent:#1a3a6b;
    --c-card-feature:linear-gradient(135deg,#1a3a6b 0%,#2a5298 100%);

    --c-copper:#b8860b; --c-copperBg:#fffbeb;
    --c-copperA:rgba(184,134,11,0.13);
  ...
  html[data-theme="dark"] {
    ...
    --c-accent:#4a90d9;
    --c-card-feature:linear-gradient(135deg,#0d2b55 0%,#1a4a8a 40%,#4a90d9 100%);

    --c-copper:#d4a017; --c-copperBg:#1d1711;
    --c-copperA:rgba(212,160,23,0.13);
  ...
  html[data-theme="dark"] [style*="color:#4b5563"],html[data-theme="dark"] [style*="color:#6b7280"] { color:var(--c-t2)!important; }
  ...
  html[data-theme="dark"] [style*="background:#f3f4f6"] { background:var(--c-surface)!important; }
